...
Curator includes the following third-party font software. These components are
licensed separately from the rest of the project. Their inclusion does not
change the license that applies to Curator's own source code.
...
Manrope and Source Serif 4 are licensed under the SIL Open Font License,
Version 1.1:
...
The original per-font license files are also distributed with the Folio theme
under `themes/folio/assets/fonts/`.